<template>
    ...
    <div class="row position-relative">
      <div class="col">
        <div class="d-flex justify-content-between title-block align-items-center">
          <div class="page-title"><router-link to="/newsletters"><img class="px-3 pb-2" src="@/assets/images/icons/Stroke.png">Запланированные</router-link></div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container relative">
    ...
    <div class="row">
      <div class="col">
        <div v-if="searchActive.length>0" class="users-block bg-gray search-result-block z-2">
          <table id="dataTable" class="personal-table mt-5">
            <thead>
            <tr >
    ...
    <div class="container">
      ...
      <div class="col">
        <div class="d-flex justify-content-between title-block align-items-center">
          <div class="table-title">11.09.2024</div>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="col">
        <div class="d-flex justify-content-between title-block align-items-center">
          <div class="table-title">01.01.2024</div>
        </div>
      </div>
