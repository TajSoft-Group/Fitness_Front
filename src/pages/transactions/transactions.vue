          ...
          <div class="cardUser p-3 d-flex align-items-center"
            ...
            <div class="col-md-8 pe-2">
              ...
              <p class="m-0 d-flex justify-content-between w-100">
                ...
                <span>{{ userTransactions.user.cards[0].balance }} TJS</span>
              </p>
              <p class="m-0 d-flex justify-content-between w-100">
                <span class="color-yellow">Карта</span>
                <span>{{ userTransactions.user.cards[1].balance }} баллов</span>
              </p>
            </div>
            <div class="col-md-1 text-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="22" viewBox="0 0 14 22" fill="none">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0.913144 21.488C0.271946 20.8773 0.271946 19.8872 0.913145 19.2765L9.60351 11L0.913149 2.72347C0.271951 2.11281 0.271951 1.12272 0.913149 0.512059C1.55435 -0.0986072 2.59394 -0.0986071 3.23514 0.512059L13.0865 9.8943C13.7277 10.505 13.7277 11.495 13.0865 12.1057L3.23513 21.488C2.59393 22.0986 1.55434 22.0986 0.913144 21.488Z" fill="#D0FD3E"/>
              </svg>
            </div>
          </div>
