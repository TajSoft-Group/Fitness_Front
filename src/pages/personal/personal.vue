<template>
    ...
    <div class="row relative">
      ...
      <div class="col">
        ...
        >
          ...
          >
            <button
              @click="toggleModal('.add-user-modal')"
              class="add-user-btn"
            >
              Добавить
            </button>
      ...
      <form class="form" @submit.prevent="submitForm(), (addCard = false)">
        ...
        <div class="ps-3 img-card d-flex flex-wrap">
          <div
            ...
            :key="index"
            :class="{ 'bg-black_2': activeColor === color }"
            class="p-2"
          >
            <div
  ...
  <div class="container relative">
    ...
    <div class="row">
      <div class="col">
        <div
          v-show="searchActive.length > 0"
          class="users-block search-result-block"
        >
          <table>
            <thead>
              <tr style="opacity: 0">
      ...
      <div class="col">
        <div class="users-block">
          <table class="personal-table">
            ...
            <tbody>
              <tr
                v-for="personal in DataUsers"
                class="align-items-center personal-tr"
              >
                <td class="d-flex justify-content-center align-items-center">
                  <router-link
                    :to="{ name: 'TrainerPage', params: { id: personal.id } }"
                    class="d-flex col-8 align-items-center"
                  >
                    <div
                      class="personal-img"
                      :style="{ borderColor: personal.color }"
                    >
                      <img
                        :src="
...
export default {
  ...
  methods: {
    ...
    handleFileChange(inputNumber) {
      const fileInput =
        inputNumber === 1 ? this.$refs.fileInput1 : this.$refs.fileInput2;
