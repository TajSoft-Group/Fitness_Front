        ...
        <div class="container">
            <form class="form" @submit.prevent="submitForm(),toggleModal('.add-curs')">
                <div @click.stop  class="col content cardBlack">
                    ...
                    <div class="img-card benefitsBg px-4 py-5 mt-4 mx-5" v-for="(item, index) in formData.benefits_course" :key="index">
                        <div class="d-flex mt-2 mb-4">
                            <input autocomplete="off" type="text" placeholder="Заголовок" v-model="formData.benefits_course[index].title">
                        ...
                        <textarea type="text" v-model="formData.benefits_course[index].description" placeholder="Описание" class="description pt-2"></textarea>
                            ...
                            <div :id="'collapseOne' + index" class="accordion-collapse collapse" :class="{ 'show': index === 0 }" :aria-labelledby="'headingOne' + index" :data-bs-parent="'#accordionExample' + index">
                                <div class="accordion-body">
                                    <div class="img-card benefitsBg px-4 py-5 mt-4">
                                        <div class="d-flex mt-2 mb-4">
                                            <input autocomplete="off" type="text" placeholder="Заголовок" v-model="formData.training_days[index].title">
                                        </div>
                                        <textarea type="text" v-model="formData.training_days[index].description" placeholder="Описание" class="description pt-2"></textarea>
                                    </div>
                                    <div class="form position-relative mt-5 mb-5">
                                        <div class="img-card row p-3 flex-wrap">
                                          <!-- v-for="(image, imgIndex) in images" :key="imgIndex"   -->
                                            ...
                                            <!-- @click="selectImage" -->
                                            <div class="card-button align-content-center text-center m-2" @click="selectDaysImage('fileInputDays' + index)">
                                                <div class="border py-3 m-2">
                                                    <button type="button" class="add-button border-0">+</button>
                                                    <br>
                                                    <span>Добавить фотографию</span>
                                            ...
                                            <div :id="'exerciseItem' + index" class="accordion-collapse collapse" :class="{ 'show': index === 0 }" :data-bs-parent="'Exercises' + index">
                                                <div class="accordion-body pb-3 clearfix">
                                                    <div class="img-card benefitsBg px-4 py-5 mt-4 mb-3" v-for="(value, index2) in formData.training_days[index].exercises" :key="index2">
                                                        <div class="d-flex mt-2 mb-4">
                                                            <input autocomplete="off" type="text" placeholder="Заголовок" v-model="formData.training_days[index].exercises[index2].title">
                                                        </div>
                                                        ...
                                                        <textarea type="text" placeholder="Описание" class="description pt-2" v-model="formData.training_days[index].exercises[index2].description"></textarea>
                                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between my-4">
                                      <div class="d-flex align-items-center mx-5 cardBg borderBlack px-3">
                                        ...
                                        <input type="text" class="outline-none" placeholder="Калории" v-model="formData.training_days[index].simple_reports.calorie">
                                      </div>
                                      ...
                                      <div class="d-flex align-items-center mx-5 cardBg borderBlack px-3">
                                        ...
                                        <input type="text" class="outline-none" placeholder="Время" v-model="formData.training_days[index].simple_reports.time">
                                      </div>
                                      ...
                                      <div class="d-flex align-items-center mx-5 cardBg borderBlack px-3">
                                        ...
                                        <input type="text" class="outline-none" placeholder="Дистанция" v-model="formData.training_days[index].simple_reports.distance">
                                      </div>
                                      ...
                                      <div class="d-flex align-items-center mx-5 cardBg borderBlack px-3">
                                        ...
                                        <input type="text" class="outline-none" placeholder="Шаги" v-model="formData.training_days[index].simple_reports.steps">
                                      </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between my-4">
                                      <div class="d-flex align-items-center mx-5 cardBg borderBlack px-3">
                                        ...
                                        <input type="text" class="outline-none" placeholder="Калории" v-model="formData.training_days[index].max_reports.calorie">
                                      </div>
                                      ...
                                      <div class="d-flex align-items-center mx-5 cardBg borderBlack px-3">
                                        ...
                                        <input type="text" class="outline-none" placeholder="Время" v-model="formData.training_days[index].max_reports.time">
                                      </div>
                                      ...
                                      <div class="d-flex align-items-center mx-5 cardBg borderBlack px-3">
                                        ...
                                        <input type="text" class="outline-none" placeholder="Дистанция" v-model="formData.training_days[index].max_reports.distance">
                                      </div>
                                      ...
                                      <div class="d-flex align-items-center mx-5 cardBg borderBlack px-3">
                                        ...
                                        <input type="text" class="outline-none" placeholder="Шаги" v-model="formData.training_days[index].max_reports.steps">
                                      </div>
                                    </div>
                ...
                <div class="w-100 mt-5 pt-5 d-flex justify-content-around">
                  ...
                  <button class="active border-0 px-5 py-3" type="submit">Отправить</button>
                  <button class="active border-0 px-5 py-3">Сохранить</button>
                </div>
            </form>
        </div>
   </section>
